...
<body>
	<body>
		...
		<div class="row">							
				...
				<div class="col-md-8">
					<h1><i class="fa fa-coffee"> Pilih Minuman Kesukaan Anda</i></h1>
				</div>
			</div>
		</div>	
			<?php  
		...
		<div id="container1">			
			...
			<div class="col-md-4">
				<div class="card" style="background-color: orange">
					...
					<a href="#"><img src="assets/img/produk/<?=$produk['gambar']?>" class="img-thumbnail" alt="avatar" data-container="body" data-toggle="popover" data-placement="top" data-content="<?php echo $produk['deskripsi_prod']; ?>" style="height: 300px;width: 500px"></a>
					<div class="card-body">							
						<b class="card-title">harga : <?php echo  $produk['harga'] ?></b>
	...
	<script type="text/javascript" src="assets/js/search1.js"></script>
